       ...
       <div className='container border-top mt-5 ' >
        <div className='row mt-5'>
            <div className='col-3'>
                ...
                <p>
                    &copy; 2010 - 2024,Not Zerodha Broking Ltd. All rights reserved.</p>
            </div>
            <div className='col-3'>
                <p>Company</p> 
                <a href=""  style={{textDecoration:"none"}} className='mb-6' >About</a>
                <br/>
                <a href=""  style={{textDecoration:"none"}}>Products</a>
                <br/>
                <a href=""  style={{textDecoration:"none"}}>Pricing</a>
                <br/>
                <a href=""  style={{textDecoration:"none"}}>Referal programme</a>
                <br/>
            ...
            <div className='col-3'>
                <p>Accounts</p>
                <a href="" style={{textDecoration:"none"}}> Open an About</a>
                <br/>
                <a href="" style={{textDecoration:"none"}}>Fund transfer</a>
                <br/>
                <a href="" style={{textDecoration:"none"}}>60 days challenges</a>
                
            </div>
        </div>
        <div className='mt-5 text-small text-muted fs-6' style={{fontSize:"14px"}}>
        <p>
