        ...
        <div className='container mt-5'>
            <div className='row'>
                ...
                <div className='col-6'>
                    ...
                    <p>Versity, the largest online stock market education book in the world covering everything from the basic to advance trading.  </p>
                    <a href="" className='mx-5' style={{textDecoration:"none"}}>Versity<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    <p className='mt-5'>TradingQ&A, the most active trading and investment community in india for all your market and queries.</p>
